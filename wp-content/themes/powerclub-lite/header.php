...
<?php esc_html_e( 'Skip to content', 'powerclub-lite' ); ?>
</a>
...
<div class="header">
  <div class="container">
    ...
    <div class="toggle"> <a class="toggleMenu" href="#">
      <?php esc_html_e('Menu','powerclub-lite'); ?>
      </a> </div> <!-- toggle -->
    <div class="sitenav">
...
<?php if(!empty($slider_Arr)){ ?>
    <div id="slider" class="nivoSlider">
        ...
        <?php }else{ ?>
        <img src="<?php echo esc_url( get_template_directory_uri() ) ; ?>/images/slides/defaultslider.jpg" title="#slidecaption<?php echo esc_attr( $i ); ?>" alt="<?php echo esc_attr($alt); ?>" />
        <?php } ?>
        <?php $i++; endwhile; ?>
    </div>   
